<%@ page title="" language="C#" masterpagefile="~/Admin/AdminHome.master" autoeventwireup="true" inherits="AdminStudyAbroad, App_Web_3lngnvem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="Server">
    <head id="Head1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function Data() {
                var Country = document.getElementById('ContentPlaceHolder1_txtcountry');
                if (Country.value == "") {
                    var Lbl = document.getElementById('ContentPlaceHolder1_Label1');
                    Lbl.innerHTML = "Please Enter Country";
                    popup('popUpDiv');
                    return false;
                }
                else {
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table id="tbl1" align="center" width="100%">
        <tr>
            <td colspan="5" align="center">
                <h1>
                    <asp:Label ID="lbladminstudy" runat="server" Text="ENTER COUNTRY" Font-Size="X-Large"></asp:Label>
                </h1>
            </td>
        </tr>
    </table>
                    ...
                    <div style="overflow: auto; height: 100%; width: 100%;">
                        <div style="width: 100%;">
                            <asp:GridView ID="gridviewcountry" runat="server" AutoGenerateColumns="False" Width="100%"
                                HeaderStyle-Height="22px" HeaderStyle-Font-Size="13px" DataKeyNames="countryid"
                                OnRowCancelingEdit="gridviewcountry_RowCancelingEdit" OnRowCommand="gridviewcountry_RowCommand"
                                OnRowEditing="gridviewcountry_RowEditing" OnRowUpdating="gridviewcountry_RowUpdating"
                                ShowFooter="True" AllowPaging="True" PageSize="5" OnPageIndexChanging="gridviewcountry_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
                                        <FooterTemplate>

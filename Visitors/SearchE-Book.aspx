<%@ page title="" language="C#" masterpagefile="~/Visitors/Visitor.master" autoeventwireup="true" inherits="Visitors_SearchE_Book, App_Web_aydit35v" %>
                                        ...
                                        <table style="margin-top: 0px;" align="center" width="100%">
                                            <tr align="left">
                                                <td colspan="5">
                                                    <div style="overflow: auto; height: 100%; width: 100%;">
                                                        <div style="width: 100%;">
                                                            <asp:Repeater ID="repeaterebook" runat="server" 
                                                                onitemcommand="repeaterebook_ItemCommand">
                                                                <HeaderTemplate>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:LinkButton ID="lnkbtnbook" runat="server" BackColor="#EBEFF0" CommandName="Download"
                                                                                    CommandArgument='<%#bind("bookfile") %>'>Download....</asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </ItemTemplate>
